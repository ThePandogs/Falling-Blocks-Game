...
public class PieceS extends Piece {
    ...
    /**
     * Constructs a new PieceS.
     *
     * @param game the game instance
     * @param panel the parent panel where the piece is rendered
     */
    public PieceS(Game game, JPanel panel) {
        super(game, panel, RED);

        firstBlock = new Block((panel.getWidth() / 2), 0, color);
    ...
    public boolean rotate() {
        ...
        // Rotation logic for the "S" piece
