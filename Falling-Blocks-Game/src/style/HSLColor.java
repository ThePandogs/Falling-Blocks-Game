...
/**
 * Utility class for handling colors in the HSL (Hue, Saturation, Luminance) color space.
 * Allows conversion between RGB and HSL color representations.
 * 
...
/**
 * Returns a string representation of this {@code HSLColor} object.
 * 
 * @return a string representation of this {@code HSLColor} object, including
 *         the values of hue, saturation, luminance, and alpha.
 */
...
/**
 * Converts an RGB Color to its corresponding HSL (Hue, Saturation, Luminance) values.
 *
 * @param color The RGB Color to convert.
 * @return An array containing the three HSL values in the order: Hue, Saturation, Luminance.
 */
